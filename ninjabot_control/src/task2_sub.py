...
def image_callback(ros_image):
  ...
  #convert ros_image into an opencv-compatible image
    try:
        ...
        print(e)
    #from here we can do any kind of image_processing
...
def detect_ball_in_frame(im_frame):
...
def filter_color(rgb_image, lower_bound_color, upper_bound_color):
    ...
    #hsv_image_show = cv2.resize(hsv_image,(0,0),fx=0.5,fy=0.5)
...
def main():
    rospy.init_node('tennis_ball_sub', anonymous=True)
